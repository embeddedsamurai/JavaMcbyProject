...
public class DailyBarGraphRenderer implements ReadDBListener {
	 ...
	 * @param h
	 */
	public DailyBarGraphRenderer(int width, int height){				
		this.width = width;
		this.height = height;
	...
	public void onCompleteReadDB(int[] data,int type,long time) {
		System.out.println("#onCompleteReadDB@staticWave,DailyBarGraph");
		...
		case ReadNumOfDBData.TYPE_PLS_NUM:
			typeStr ="脈波";
			break;
		case ReadNumOfDBData.TYPE_HR_NUM:
			typeStr ="心拍数";
			break;
		case ReadNumOfDBData.TYPE_BP_NUM:
			typeStr ="血圧";
			break;
		}//End of switch
